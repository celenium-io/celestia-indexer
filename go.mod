...
replace (
	...
	// indexer-sdk pulls gnark-crypto v0.20.1 (indirect, unused in its code) which
	// dropped field/eisenstein; celestia-app v9's zkism->gnark needs it, so pin the
	// version that still has the package.
