...
type BlockStats struct {
	...
	SupplyChange  types.Numeric `bun:",type:numeric"            comment:"Change of total supply in the block"                               stats:"func:min max sum avg"`
	InflationRate types.Numeric `bun:",type:numeric"            comment:"Inflation rate"                                                    stats:"func:min max avg"`
	Fee           types.Numeric `bun:"fee,type:numeric"         comment:"Summary block fee"                                                 stats:"func:min max sum avg"`
	Rewards       types.Numeric `bun:"rewards,type:numeric"     comment:"Total rewards per block"                                           stats:"func:min max sum avg"`
	Commissions   types.Numeric `bun:"commissions,type:numeric" comment:"Total commissions per block"                                       stats:"func:min max sum avg"`
