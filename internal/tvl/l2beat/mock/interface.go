...
func (m *MockIApi) TVL(ctx context.Context, rollupName string, timeframe storage.TvlTimeframe) (l2beat.TVLResponse, error) {
	m.ctrl.T.Helper()
...
func (c *MockIApiTVLCall) Do(f func(context.Context, string, storage.TvlTimeframe) (l2beat.TVLResponse, error)) *MockIApiTVLCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockIApiTVLCall) DoAndReturn(f func(context.Context, string, storage.TvlTimeframe) (l2beat.TVLResponse, error)) *MockIApiTVLCall {
