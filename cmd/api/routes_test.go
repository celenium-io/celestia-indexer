...
func TestRoutes(t *testing.T) {
	var expectedRoutes = map[string]struct{}{
		...
		"/v1/validators GET":                                  {},
		"/v1/validators/metrics GET":                          {},
		"/v1/validators/:id GET":                              {},
		"/v1/validators/:id/metrics GET":                      {},
		"/v1/validators/:id/bond_updates GET":                 {},
		"/v1/stats/tps GET":                                   {},
		...
		"/v1/hyperlane/zkism GET":                             {},
		"/v1/hyperlane/zkism/:id GET":                         {},
		"/v1/hyperlane/zkism/:id/updates GET":                 {},
		"/v1/hyperlane/zkism/:id/messages GET":                {},
		"/v1/signal GET":                                      {},
