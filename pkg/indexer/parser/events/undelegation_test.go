	...
	tests := []struct {
	...
	}{
		{
			...
			undelegation: &storage.Undelegation{
				Height:         844186,
				Time:           ts,
				Amount:         types.NewNumeric(decimal.RequireFromString("144000000")),
				...
				Address: &storage.Address{
					...
					Balance: storage.Balance{
						...
						Delegated: types.NewNumeric(decimal.RequireFromString("-144000000")),
						Spendable: types.NewNumeric(decimal.Zero),
						Unbonding: types.NewNumeric(decimal.RequireFromString("144000000")),
					},
				},
				Validator: &storage.Validator{
					...
					Stake:             types.NewNumeric(decimal.RequireFromString("-144000000")),
				},
			},
		}, {
			...
			undelegation: &storage.Undelegation{
				Height:         75,
				Time:           ts,
				Amount:         types.NewNumeric(decimal.RequireFromString("30000")),
				...
				Address: &storage.Address{
					...
					Balance: storage.Balance{
						Currency:  currency.Utia,
						Delegated: types.NewNumeric(decimal.RequireFromString("-30000")),
						Spendable: types.NewNumeric(decimal.Zero),
						Unbonding: types.NewNumeric(decimal.RequireFromString("30000")),
					},
				},
				Validator: &storage.Validator{
					...
					Rewards:           types.NewNumeric(decimal.Zero),
					Commissions:       types.NewNumeric(decimal.Zero),
					Stake:             types.NewNumeric(decimal.RequireFromString("-30000")),
				},
			},
		}, {
			name: "undelegate v4",
			...
			undelegation: &storage.Undelegation{
				Height:         75,
				Time:           ts,
				Amount:         types.NewNumeric(decimal.RequireFromString("1000000")),
				...
				Address: &storage.Address{
					...
					Balance: storage.Balance{
						Currency:  currency.Utia,
						Delegated: types.NewNumeric(decimal.RequireFromString("-1000000")),
						Spendable: types.NewNumeric(decimal.Zero),
						Unbonding: types.NewNumeric(decimal.RequireFromString("1000000")),
					},
				},
				Validator: &storage.Validator{
					...
					Rewards:           types.NewNumeric(decimal.Zero),
					Commissions:       types.NewNumeric(decimal.Zero),
					Stake:             types.NewNumeric(decimal.RequireFromString("-1000000")),
				},
			},
		},
	}
