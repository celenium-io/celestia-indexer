			...
			want: storage.StakingLog{
				...
				Address: &storage.Address{
					...
					Balance: storage.Balance{
						...
						Unbonding: types.NewNumeric(decimal.RequireFromString("-35570000")),
				...
				Change: types.NewNumeric(decimal.RequireFromString("-35570000")),
	...
	tests := []struct {
	...
	}{
		{
			...
			want: storage.StakingLog{
				...
				Change: types.NewNumeric(decimal.RequireFromString("-265636688")),
				Type:   types.StakingLogTypeUnbonded,
			},
		},
	}
