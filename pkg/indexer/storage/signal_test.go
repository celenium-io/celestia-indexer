...
func TestTryUpgrade_NoValidatorsSignaled(t *testing.T) {
	...
	tx.EXPECT().BondedValidators(gomock.Any(), 100).Return([]storage.Validator{
		{Id: 1, Stake: decimal.NewFromInt(1_000_000), Version: 0},
		{Id: 2, Stake: decimal.NewFromInt(1_000_000), Version: 3},
	}, nil)
...
func TestTryUpgrade_NoQuorum(t *testing.T) {
	...
	tx.EXPECT().BondedValidators(gomock.Any(), 100).Return([]storage.Validator{
		{Id: 1, Stake: decimal.NewFromInt(1_000_000), Version: 4},
		{Id: 2, Stake: decimal.NewFromInt(1_000_000), Version: 3},
		{Id: 3, Stake: decimal.NewFromInt(1_000_000), Version: 3},
	}, nil)
...
func TestTryUpgrade_WithQuorum(t *testing.T) {
	...
	tx.EXPECT().BondedValidators(gomock.Any(), 100).Return([]storage.Validator{
		{Id: 1, Stake: decimal.NewFromInt(2_000_000), Version: 4},
		{Id: 2, Stake: decimal.NewFromInt(2_000_000), Version: 4},
		{Id: 3, Stake: decimal.NewFromInt(2_000_000), Version: 4},
	}, nil)
	tx.EXPECT().UpdateSignalsAfterUpgrade(gomock.Any(), uint64(4)).
		Return(decimal.NewFromInt(6_000_000), nil)
...
func TestTryUpgrade_PicksMinimumQuorumVersion(t *testing.T) {
	...
	tx.EXPECT().BondedValidators(gomock.Any(), 100).Return([]storage.Validator{
		{Id: 1, Stake: decimal.NewFromInt(3_000_000), Version: 4},
		{Id: 2, Stake: decimal.NewFromInt(3_000_000), Version: 4},
		{Id: 3, Stake: decimal.NewFromInt(3_000_000), Version: 4},
		{Id: 4, Stake: decimal.NewFromInt(3_000_000), Version: 5},
	}, nil)
	// versions are sorted, v4 is checked first and has quorum → SaveUpgrades called, v5 skipped
	tx.EXPECT().UpdateSignalsAfterUpgrade(gomock.Any(), uint64(4)).
		Return(decimal.NewFromInt(12_000_000), nil).MaxTimes(1)
...
func TestSaveSignals_WithQuorum(t *testing.T) {
	...
	// total bonded stake
	tx.EXPECT().BondedValidators(gomock.Any(), 100).Return([]storage.Validator{
		{Id: 1, Stake: decimal.NewFromInt(2_000_000)},
		{Id: 2, Stake: decimal.NewFromInt(1_000_000)},
	}, nil)
