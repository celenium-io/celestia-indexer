...
func TestAddress_Decode(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			name:    "celestia1vdhhxmt0wvckceesv5ungm35wp6rywfsd3c8zvn5x3c8gat9xsqqtm4anj",
			a:       Address("celestia1vdhhxmt0wvckceesv5ungm35wp6rywfsd3c8zvn5x3c8gat9xsqqtm4anj"),
			want:    AddressPrefixCelestia,
			want1:   []byte{0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x31, 0x6c, 0x67, 0x30, 0x65, 0x39, 0x34, 0x6e, 0x34, 0x70, 0x74, 0x32, 0x39, 0x30, 0x6c, 0x70, 0x71, 0x32, 0x74, 0x34, 0x70, 0x74, 0x75, 0x65, 0x34, 0x0},
			wantErr: false,
		},
	}
	for _, tt := range tests {
