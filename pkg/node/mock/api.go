...
// BlobProofs mocks base method.
func (m *MockApi) BlobProofs(ctx context.Context, level types0.Level, startShare, endShare int) (types0.BlobProof, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BlobProofs", ctx, level, startShare, endShare)
	ret0, _ := ret[0].(types0.BlobProof)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// BlobProofs indicates an expected call of BlobProofs.
func (mr *MockApiMockRecorder) BlobProofs(ctx, level, startShare, endShare any) *MockApiBlobProofsCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BlobProofs", reflect.TypeOf((*MockApi)(nil).BlobProofs), ctx, level, startShare, endShare)
	return &MockApiBlobProofsCall{Call: call}
}

// MockApiBlobProofsCall wrap *gomock.Call
type MockApiBlobProofsCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockApiBlobProofsCall) Return(arg0 types0.BlobProof, arg1 error) *MockApiBlobProofsCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockApiBlobProofsCall) Do(f func(context.Context, types0.Level, int, int) (types0.BlobProof, error)) *MockApiBlobProofsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockApiBlobProofsCall) DoAndReturn(f func(context.Context, types0.Level, int, int) (types0.BlobProof, error)) *MockApiBlobProofsCall {
